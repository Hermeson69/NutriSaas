  ...
  const [training] = useState<Workout[]>([
    {
      ...
      items: [
        {
          type: "1º Exercício: ",
          description: "Rosca direta com barra (3 séries de 10-12 repetições)",
        },
        {
          type: "2º Exercício: ",
          description:
        ...
        {
          type: "3º Exercício: ",
          description: "Rosca concentrada (3 séries de 10-12 repetições)",
        },
      ],
    },
    {
      ...
      items: [
        {
          type: "1º Exercício: ",
          description: "Tríceps pulley (3 séries de 12-15 repetições)",
        },
        {
          type: "2º Exercício: ",
          description: "Mergulho em paralelas (3 séries de 10-12 repetições)",
        },
        {
          type: "3º Exercício: ",
          description:
            "Extensão de tríceps com halter (3 séries de 12-15 repetições)",
        },
      ],
    },
    {
      ...
      items: [
        {
          type: "1º Exercício: ",
          description:
            "Rosca de punho com halteres (3 séries de 15-20 repetições)",
        },
        {
          type: "2º Exercício: ",
          description: "Flexão de punho inversa (3 séries de 15-20 repetições)",
        },
        {
          type: "3º Exercício: ",
          description: "Prancha com pegada de halter (3 séries de 30 segundos)",
        },
      ],
    },
  ]);
