...
import { Dumbbell, Flame, BookmarkIcon, Activity as Running } from "lucide-react"
  ...
  return (
    <div className={cn("grid grid-cols-1 md:grid-cols-3 gap-4", className)}>
      ...
      <Card className="bg-black text-white">
        ...
        <CardContent className="flex flex-col space-y-20">
          <div>
            <p className="text-sm font-medium">Next Exercise Day:</p>
          </div>

          <Button className="w-full bg-orange-500 hover:bg-orange-600 text-white">{nextWorkout}</Button>
        </CardContent>
      </Card>
          ...
          <div className="relative h-22 w-22">
            ...
            {/* <svg className="absolute inset-0 h-full w-full" viewBox="0 0 100 100">
              <circle
                ...
                strokeDashoffset={289.02652413026095 * (1 - caloriePercentage / 100)}
                strokeLinecap="round"
